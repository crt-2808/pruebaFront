...
function PruebaMapsLeaflet() {
  ...
  const onSubmit = async (data) => {
    ...
    try {
      ...
      const FechaConclucion = FechaAsignacion;
      console.log(
                  ...
                  <Form.Group>
                    ...
                    >
                      ...
                      <InputText
                        ...
                        className="p-inputtext-sm p-d-block p-mb-2" // Puedes cambiar la clase para personalizar el estilo
                        style={{ width: "100%" }}
                      />
                    </span>
                    {isFocused && suggestions.length > 0 && (
                      <ListBox
                        ...
                        onChange={(e) => handleSelect(e.value)} // Asegúrate de que esto esté pasando el valor correcto
                        optionLabel="label"
                        style={{ width: "100%" }}
                      />
                    )}
